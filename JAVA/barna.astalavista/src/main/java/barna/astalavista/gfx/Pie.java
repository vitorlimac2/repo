...
public class Pie extends Applet {
        ...
        public static void main(String[] args) {
            ...
            pie.AddPieSlice(2836, "exon skipping", Color.BLUE);
            pie.AddPieSlice(648, "double skipping", Color.MAGENTA);
            pie.AddPieSlice(693, "alt acceptor", Color.YELLOW);
            pie.AddPieSlice(535, "alt donor", Color.GREEN);
            pie.AddPieSlice(1, "intron retention", Color.PINK);

            pie.SetTitle("Distribution");
            pie.show_percents_beside_slices= 1;
        ...
        public void setShowPercentsBesideSlices(int newVal) {
            show_percents_beside_slices= newVal;
        }
        ...
        Font font1;
        Font font2;
        public Image getPie_image() {
            return pie_image;
        }

        public void setShow_percents_on_slices(int show_percents_on_slices) {
            this.show_percents_on_slices = show_percents_on_slices;
        }

        public void setShow_values_on_slices(int show_values_on_slices) {
            this.show_values_on_slices = show_values_on_slices;
        }
